...
import com.vinnichenko.task6.controller.command.impl.FindByAuthorCommand;
...
public class FindByAuthorCommandTest {
    ...
    public Object[][] createDataExecute() {
        ...
        parameters2.put(RequestParameters.PARAMETER_AUTHORS,
                "Lev Petrov Tolstoy");
        Map<String, String> response2 = new HashMap<>();
        response2.put(ResponseParameters.STATUS, ResponseParameters.FAIL_STATUS);
        response2.put(ResponseParameters.MESSAGE, "incorrect parameter");
        return new Object[][]{
                {parameters, response},
    ...
    public void executeTest(Map<String, String> parameters,
        ...
        Command command = new FindByAuthorCommand();
