...
import com.vinnichenko.task6.controller.command.impl.SortByNumberPagesCommand;
...
public class SortByNumberPagesCommandTest {
    ...
    public void executeTest(List<CustomBook> sortedList) {
        ...
        Command command = new SortByNumberPagesCommand();
