...
import com.vinnichenko.task6.controller.command.impl.SortByTypographyCommand;
...
public class SortByTypographyCommandTest {
    ...
    public void executeTest(List<CustomBook> sortedList) {
        ...
        Command command = new SortByTypographyCommand();
